...
public class LoadAnnictReviewsApi {
    ...
    private void loadJson(String page) {//From LoadAnnictWorksApi
        System.out.println("jsonを読み込んでいます。[" + page + "]ページ目");
        this.nowPage = page;
        try {
            // InputStreamの用意
            URL url = new URL("https://api.annict.com/v1/reviews?access_token=evUnT3lwAhraTapSKpmZCmIesUfH1x60lI5zG_fpvrs&per_page=50&filter_season="
