...
public class LoadAnnictReviewsApi {
    ...
    public void loadJson(String page) {//From LoadAnnictWorksApi
        ...
        //
        System.out.println("jsonを読み込んでいます。[" + page + "]ページ目  対象Id:" + filter_work_id);
        this.nowPage = page;
        try {
            // InputStreamの用意
    ...
    private void encodeJson() {
        ...
        try {
            ...
            totalCount = annictReviewsApi.getTotal_count();
            ...
            if (!((annictReviewsApi.getNext_page() == 0) || (annictReviewsApi.getTotal_count() == 0))) {
                loadJson(nextPage);
            } else {
